...
<body>
	...
	<form class="form-container" action="addMuseumObject" method="post" enctype="multipart/form-data">
				...
				<div class="formControls">
				  ...
				  <input type="submit" class="btn btn-success" name="metoda" value="Dodaj">
